        ...
        <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex items-center border border-gray-300">
                <button
                  ...
                  className="w-10 h-10 flex items-center justify-center hover:bg-gray-50 text-lg text-gray-700"
                >
                  −
                </button>
          ...
          <button
            ...
            className={`w-full py-4 text-sm font-semibold uppercase tracking-widest transition-opacity ${
              outOfStock ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'hover:opacity-90'
            }`}
          ...
          {product.tags?.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-5">
              {product.tags.map((tag) => (
                <span key={tag} className="px-2.5 py-1 bg-gray-100 text-gray-500 text-xs rounded-sm">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div className="mt-8">
            ...
            <Accordion title="Panduan Ukuran">
              Silakan hubungi kami melalui WhatsApp untuk panduan ukuran lengkap.
            </Accordion>
            <Accordion title="Pengiriman & Pengembalian">
              Pesanan diproses 1–2 hari kerja. Konfirmasi pesanan melalui WhatsApp.
            </Accordion>
          </div>
        </div>
      </div>
